import { CloudWatchClient, GetMetricStatisticsCommand, GetMetricStatisticsCommandInput, GetMetricDataCommand, GetMetricDataCommandInput} from "@aws-sdk/client-cloudwatch";
...
const metricsController = {
  async getAllMetrics(req: Request, res: Response, next: NextFunction) {
    ...
    const client = new CloudWatchClient({
      ...
      region: 'us-east-2', // req.body.region,
    ...
    const input: GetMetricStatisticsCommandInput = {
      ...
      "EndTime": new Date(), // new Date(convertToUnix(req.body.endTime)), // Test this out
      ...
      "Statistics": ['Average', 'Sum'], // req.body.statistics, //["Sum", "Maximum", "Minimum", "Average", "SampleCount"]
      ...
      "MetricName": "Invocations", // req.body.metricName,
      ...
      "Namespace": "AWS/Lambda", // Subject to change
