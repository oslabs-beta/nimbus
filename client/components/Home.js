...
const Home = () => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("h2", { className: "text-2xl text-left text-primary" }, "Your Dashboard"),
        react_1.default.createElement("div", { className: 'flex flex-row justify-between w-full mb-8 px-14' },
            react_1.default.createElement("div", { className: "card w-1/5 bg-secondary shadow-2xl mr-2" },
                react_1.default.createElement("div", { className: "card-body p-2" },
                    react_1.default.createElement("p", { className: 'text-sm' }, "Total Invocations"),
            ...
            react_1.default.createElement("div", { className: "card w-1/5 bg-secondary shadow-xl mx-2" },
                react_1.default.createElement("div", { className: "card-body p-2" },
                    react_1.default.createElement("p", { className: 'text-sm' }, "Total Errors"),
            ...
            react_1.default.createElement("div", { className: "card w-1/5 bg-secondary shadow-xl mx-2" },
                react_1.default.createElement("div", { className: "card-body p-2" },
                    react_1.default.createElement("p", { className: 'text-sm' }, "Total Throttles"),
            ...
            react_1.default.createElement("div", { className: "card w-1/5 bg-secondary shadow-xl mx-2" },
                react_1.default.createElement("div", { className: "card-body p-2" },
                    react_1.default.createElement("p", { className: 'text-sm' }, "Avergae Duration"),
                    react_1.default.createElement("div", { className: 'w-full text-center text-3xl text-base-100 mb-2' }, averageDuration.toLocaleString(undefined, { maximumFractionDigits: 2 })))),
            react_1.default.createElement("div", { className: "card w-1/5 bg-accent shadow-xl ml-2" },
                react_1.default.createElement("div", { className: "card-body p-2" },
                    react_1.default.createElement("p", { className: 'text-sm' }, "Cost"),
