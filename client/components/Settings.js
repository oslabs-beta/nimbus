...
const Settings = () => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: 'flex flex-col lg:flex-row w-full' },
            react_1.default.createElement("div", { className: "lg:basis-1/2 lg:pl-20 lg:pr-8 px-20" },
        ...
        (errorMessage !== '' && successMessage === '')
            &&
                react_1.default.createElement("div", { className: "alert alert-error shadow-lg fixed top-0 lg:left-60 mt-1" },
        ...
        successMessage !== ''
            &&
                react_1.default.createElement("div", { className: "alert alert-success shadow-lg fixed top-0 lg:left-60 mt-1" },
                    react_1.default.createElement("div", null,
                        react_1.default.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className: "stroke-current flex-shrink-0 h-6 w-6", fill: "none", viewBox: "0 0 24 24" },
