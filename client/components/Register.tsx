    ...
    <div>
      ...
      <form onSubmit={submitForm}>
        ...
        <div>
          ...
          <br></br>
          Please follow the steps below to set up the connection to your AWS account. Click <a target="_blank" href="https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/create/review?templateURL=https://cf-templates-fo1de99kotoi-us-east-1.s3.amazonaws.com/2022347I7Q-nimbus.yaml&stackName=NimbusStack">HERE</a> to start the process.
        ...
        <label htmlFor="arn">ARN</label><br></br>
        <input 
          type="text" 
          id="arn" 
          name="arn"
